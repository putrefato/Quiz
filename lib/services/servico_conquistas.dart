    ...
    for (var conquista in conquistas) {
      if (!conquista.desbloqueada) {
        ...
        if (desbloquear) {
          ...
          // Poderia adicionar notificação aqui
        }
      }
    }
  }
  ...
  Future<List<Conquista>> obterConquistasUsuario(int usuarioId) async {
    ...
    return conquistasBase.map((base) {
      ...
      return Conquista(
        ...
        dataDesbloqueio: conquistaUsuario.isNotEmpty ?
          DateTime.fromMillisecondsSinceEpoch(conquistaUsuario['data_desbloqueio']) : null,
        tipo: base.tipo,
